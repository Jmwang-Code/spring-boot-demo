package processor.datasource.factory;
...
import processor.datasource.nosql.adapter.HiveJDBCAdapter;
import processor.datasource.nosql.adapter.MongoDBJDBCAdapter;
...
import static common.exception.enums.StructuredErrorCodeConstants.DATABASE_INPUT_TYPE_ERROR;
import static common.exception.enums.StructuredErrorCodeConstants.UNSUPPORTED_DATABASE_TYPE;
