<span style="color: red"> springboot3.0开始，废弃了WebSecurityConfigurerAdapter
而使用安全过滤链</span>

# SecurityFilterChain 安全过滤链
那么在 Spring Security 中给我们提供过滤器,对HTTP进行全方位管理. 
...
默认的三个
![img.png](SpringSecurity.assets/img.png)
还有配置好的十一个
![img.png](SpringSecurity.assets/img1.png)