...
![img_5.png](../images/MYSQL-非聚集索引（辅助索引、非聚簇索引、二级索引）.png)
...
## 12.2 InnoDB 引擎层
![img_17.png](../images/MYSQY-InnoDB%20引擎层.png)
...
![img_11.png](../images/MYSQY-宕机恢复数据.png)
...
2. 写入物理表文件中出错
   ![img_14.png](../images/MYSQL-物理表文件写入出错.png)
